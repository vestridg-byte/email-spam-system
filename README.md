...
- `data/predictions.csv`: generated output file by the notebook when the program is executed

Note: `data/predictions.csv` is not a manually created source file. It is produced automatically after running `main_notebook.ipynb`.
